...
function Signup() {
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#0b0f19] px-4 py-10">
      ...
      <div className="pointer-events-none absolute -top-40 -right-40 w-96 h-96 rounded-full bg-fuchsia-600/25 blur-3xl" />
      <div className="pointer-events-none absolute -bottom-40 -left-40 w-96 h-96 rounded-full bg-violet-600/20 blur-3xl" />
